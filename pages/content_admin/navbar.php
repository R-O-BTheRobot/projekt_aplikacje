<nav class="main-header navbar navbar-expand navbar-white d-flex justify-content-between">
  ...
  <div class="p-2 row">
    <a class="nav-link" href="./adminpanel.php" role="button" data-toggle="tooltip" data-placement="bottom" title="Zarządzanie użytkownikami"><i class="fas fa-address-book"></i></a>
    <a class="nav-link" href="./modpanel.php" role="button" data-toggle="tooltip" data-placement="bottom" title="Zarządzanie inwentarzem"><i class="fas fa-table"></i></a>
